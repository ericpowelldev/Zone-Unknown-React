...
const events = {
  ...
  item: [
    ...
    {
      text: `You found the Efficiency Tank! This item gives a +${g.glob.O2gainI - g.glob.O2gain} bonus when replenishing your O2 at the ship & raises your max O2 from ${g.glob.O2max} to ${
        g.glob.O2maxI
      }.`,
    },
  ],
