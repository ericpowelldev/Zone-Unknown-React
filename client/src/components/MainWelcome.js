...
class MainWelcome extends React.Component {
  ...
  render() {
    return (
      <div id="mainMenuBox">
        <h1 className="hShade" id="mainMenuHeader">
          Welcome {this.props.username}
        </h1>
        <p className="mShade" id="mainMenuExplain">
          ZONE UNKNOWN is an adventure game based on survival. You find yourself stranded in a solar system due to your warp drive breaking down. Explore {g.sav.planets.length} planets and find parts
          to rebuild your warp drive. Along the way, you will encounter harsh events that will test your survival skills. You need to manage your HEALTH, OXYGEN and FUEL. You lose {g.glob.O2loss}{" "}
          OXYGEN per turn and will need {g.glob.FUELrep} FUEL to replenish your O2 at the ship (middle hex). When your HEALTH hits 0, you lose! To advance to the next planet, collect the warp drive
          piece and return to your ship. Good luck!
        </p>
