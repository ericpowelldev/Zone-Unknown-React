    ...
    render() {
        return (
            <div id="mainMenuBox">
                ...
                <Link to="/game" onClick={this.handleLoadGame}><div className="mainMenuBtn" id="loadBtn" onMouseEnter={this.sfx}>
                    <p className="mainMenuBtnText">Load Game</p>
                </div></Link>
                <Link to="/game" onClick={this.handleNewGame}><div className="mainMenuBtn" id="newBtn" onMouseEnter={this.sfx}>
                    <p className="mainMenuBtnText">New Game</p>
                </div></Link>
                <Link to="/" onClick={this.handleSignOut}><div className="mainMenuBtn" id="signOutBtn" onMouseEnter={this.sfx}>
