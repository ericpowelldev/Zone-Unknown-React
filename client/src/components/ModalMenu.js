    ...
    render() {
        return (
            <div id="modal">
                ...
                <p>You will always start the game with 20 HP and 20 Oxygen and no Fuel or Items. You will gather Fuel as you explore the planet. </p>
                <p>Along the way you may also find other items that will increase your chances of survival. There are six items in all that can assist you on your journey.</p>
                <ol>
                    <li>Shield: This item gives a +1 defense bonus on all negative HP events</li>
                    <li>Rebreather: This item gives a +1 defense bonus on all negative O2 events</li>
                    <li>Syphon: This item gives a +1 collection bonus on all gain fuel events</li>
                    <li>AI Drone: This item helps you achieve better outcomes on dynamic HP events</li>
                    <li>AI Drone Upgrade: This item helps you achieve better outcomes on dynamic O2 events</li>
                    <li>Efficiency Tank: This item gives a +5 bonus when replenishing your oxygen at the ship and raises your max oxygen to 30</li>
                </ol>
