  ...
  render() {
    return (
      <div id="mainMenuBox">
        ...
        />
        <input className="mainMenuInput" id="passwordInput" type="password" name="password" placeholder="Password (6-25 characters)" value={this.state.password} onChange={this.handleChange} />
        <input className="mainMenuInput" id="confirmInput" type="password" name="confirm" placeholder="*Confirm Password (Sign up only)" value={this.state.confirm} onChange={this.handleChange} />
